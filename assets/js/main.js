...
const portfolioItems = [
  ...
  },
  {
    ...
    description:
      "Do you need the most extreme? These TNTs not only destroy bases, but also entire villages and large cities. Have fun with them! <br><br>+ Over 40 different Giant TNTs<br>+ Maximum destruction and explosions<br>+ Tornado, meteor, 5,000x and more TNTs!<br><br>++ Use it on your world! <br>++ Multiplayer friendly!<br>",
  },
  {
    id: 4,
    ...
    description:
      "Immerse yourself in the soothing beauty of pastel textures and colors.<br><br>+ 1.21 Tricky Trials textures update<br>+ Everything retextured in pastel style<br>+ New mob, animal and boss models<br>+ Texture block variations<br>+ Animated ores<br>+ Attention to detail<br><br>++ Use this texture pack in your world!",
  },
  {
    id: 5,
    title: "Zombie Bunker",
    ...
    description:
      "Protect your friends and yourself from a Zombie Apocalypse in a high security base! Your underground bunker has everything you need to survive. Press buttons and activate the anti-zombie walls!<br><br>+ Activatable safety walls<br>+ Secret bunker<br>+ Secure base<br>+ Zombie apocalypse<br>+ Custom zombies<br>++ Multiplayer and singleplayer",
  },
  {
    id: 6,
    title: "More Creepers",
  ...
  portfolioItems.forEach((item) => {
    ...
    portfolioItem.innerHTML = `
        <button data-modal-target="portfolio-modal" data-modal-toggle="portfolio-modal"
          class="block text-white bg-[#202020] font-medium rounded-lg text-sm px-2 py-3 text-center w-[90%] hover:opacity-70  hover:border-[#d44500] hover:border-[1px] hover:space-y-2 portfolio-item transition-all duration-300 ease-in-out"
      ...
      if (item) {
        ...
        modalContent.innerHTML = `
          ...
          <div class="slider-container relative">
            ...
            <button class="prev-button absolute left-5 top-1/2 transform -translate-y-1/2 bg-[#ff6100] text-white p-2 rounded-l-md hover:bg-[#d44500] transition-all duration-300 z-20">
              <i class="ri-arrow-left-line"></i>
            </button>
            <button class="next-button absolute right-5 top-1/2 transform -translate-y-1/2 bg-[#ff6100] text-white p-2 rounded-r-md hover:bg-[#d44500] transition-all duration-300 z-20">
